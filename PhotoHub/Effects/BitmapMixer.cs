...
namespace PhotoHub
{
   ...
   public class BitmapMixer
   {
      ...
      public WriteableBitmap Mix(WriteableBitmap input1, WriteableBitmap input2)
      {
         ...
         return Mix(input1.Pixels, input2.Pixels).ToWritableBitmap(width, height);
      }
      ...
      public int[] Mix(int[] inputPixels1, int[] inputPixels2)
      {
          if (inputPixels1 == null || inputPixels2 == null)
          {
              return null;
          }
